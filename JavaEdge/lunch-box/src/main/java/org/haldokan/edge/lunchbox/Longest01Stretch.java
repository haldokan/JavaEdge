...
/**
 * find the indexes of the shortest and longest streches of 1s, and 0s in the
 * array
 * 
 * @author haldokan
 *
...
public class Longest01Stretch {
	public static void main(String[] args) {
		...
		int[] a = new int[] { 0, 0, 1, 1, 1, 0, 0, 0, 1, 1, 0, 0, 1, 1, 1, 0,
		...
		System.out.println("s0/e0/max0/e0-s0/strech: " + s0 + "/" + e0 + "/"
				+ max0 + "/" + (e0 - s0)
				+ Arrays.toString(Arrays.copyOfRange(a, s0, e0)));
		System.out.println("s1/e1/max1/e1-s1/strech: " + s1 + "/" + e1 + "/"
				+ max1 + "/" + (e1 - s1)
