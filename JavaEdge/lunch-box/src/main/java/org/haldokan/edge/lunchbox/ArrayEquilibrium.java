...
/**
 * A point of equilibrium at index p in a 0-based array of length N is a point 0
 * >= p < N where the sum of elements b/w 0 and p - 1 is equal to that b/w p+1
 * and N-1. assum that the sum of elements to the left of index 0 is 0. write a
...
public class ArrayEquilibrium {
	...
	public static void main(String[] args) {
		...
		if (a.length > 1) {
			...
			if (sumleft == sumright)
				System.out.println("p/eqlsum: " + (a.length - 1) + "/"
						+ sumleft);
		}
