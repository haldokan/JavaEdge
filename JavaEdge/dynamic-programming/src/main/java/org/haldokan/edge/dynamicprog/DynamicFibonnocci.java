...
/**
 * Solution is based on the dynamic programming implementation presented by
...
public class DynamicFibonnocci {
	public static void main(String[] args) {
		...
		System.out.println("dynfib with storage (" + num + "): "
				+ dynfibWithStorage(num));
		System.out.println("dynfib w/o storage (" + num + "): "
				+ dynfibWithoutStorage(num));
		System.out.println("dynfib w/o storage2 (" + num + "): "
				+ dynfibWithoutStorage2(num));
	}
