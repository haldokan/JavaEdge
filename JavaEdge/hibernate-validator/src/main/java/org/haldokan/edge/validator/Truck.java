...
@ValidPassengerCount(value = VehicleType.TRUCK, message = "Number of dudes in the car should not exceed the seat count", groups = ValidationGroups.CapacityChecks.class, payload = ViolationSeverity.Warn.class)
public class Truck implements Vehicle {
	...
	public String toString() {
		return "Car [manufacturer=" + manufacturer + ", licensePlate="
				...
				+ ", passedVehicleInspection=" + passedVehicleInspection
				+ ", driver=" + driver + ", passengerCount=" + passengerCount
				+ "]";
	}
}
