 ...
 * Examine the Generified version here: GenerifiedLongestSubsequence (can be increasing or decreasing based on the
 * comparator passed to the class)
 * Look at the generified version of this solution here: GenerifiedLongestSubsequence
 *
 * The Question: 5_STAR
 *
...
public class LongestIncreasingSubsequence {
    public static void main(String[] args) {
        ...
        driver.testSequenceTracker();
        driver.testLongestSequence();
    }
    ...
    public int[] longestSequence(int[] arr) {
        ...
        int[] longestSequence = new int[sequenceStack.size()];
        int index = 0;
    ...
    private int[][] buildSequenceTracker(int arr[]) {
    ...
    private void testSequenceTracker() {
        int[] arr = new int[]{-1, 2, 100, 100, 101, 3, 4, 5, -7, -6};
        int[][] seqTracker = buildSequenceTracker(arr);
    ...
    private void testLongestSequence() {
        int[] arr = new int[]{-1, 2, 100, 100, 101, 3, 4, 5, -7, -6};
        int[] longestSeq = longestSequence(arr);
        assertThat(longestSeq, is(new int[]{-1, 2, 3, 4, 5}));

        arr = new int[]{-1, 2, 100, 100, 101, 3, 4, 5, -7, -6, -4, -3, -1, 0};
        longestSeq = longestSequence(arr);
        assertThat(longestSeq, is(new int[]{-7, -6, -4, -3, -1, 0}));

        arr = new int[]{-1, 2, 100, 100, 101, 3, 4, 5, -7, -6, -4, 9, 11, -3, -1, 0};
        longestSeq = longestSequence(arr);
        assertThat(longestSeq, is(new int[]{-1, 2, 3, 4, 5, 9, 11}));
    }
