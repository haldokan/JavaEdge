...
//        driver.testGenerateStringWithProbability2();
            ...
            for (char chr : chars) {
                ...
                if (chr < 256) {
                    ...
                    if (edge != null) {
                        ...
                        probabilityGraph.add(v1, v2, Edge.create(1d));
                    }
                    previousChar = chr;
                }
            }
    ...
    private void testBuildProbabilityGraph() {
        ...
        assertThat(probabilityGraph.getEdge(Vertex.create(' '), Vertex.create('t')).weight, is(3d));
        assertThat(probabilityGraph.getEdge(Vertex.create(' '), Vertex.create('h')).weight, is(1d));
        assertThat(probabilityGraph.getEdge(Vertex.create('t'), Vertex.create('h')).weight, is(3d));
        assertThat(probabilityGraph.getEdge(Vertex.create('o'), Vertex.create('s')).weight, is(2d));
        assertThat(probabilityGraph.getEdge(Vertex.create('e'), Vertex.create(' ')).weight, is(2d));
        assertThat(probabilityGraph.getEdge(Vertex.create('s'), Vertex.create('e')).weight, is(3d));
        assertThat(probabilityGraph.getEdge(Vertex.create('h'), Vertex.create('o')).weight, is(2d));
        assertThat(probabilityGraph.getEdge(Vertex.create('h'), Vertex.create('i')).weight, is(1d));
    ...
    private static class Edge {
        ...
        public static Edge create(double weight) {
    ...
    private static class Vertex {
        ...
        public boolean equals(Object o) {
            ...
            return character == vertex.character;
