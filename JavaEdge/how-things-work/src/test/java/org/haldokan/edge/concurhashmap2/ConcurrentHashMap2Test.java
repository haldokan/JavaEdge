...
public class ConcurrentHashMap2Test {
    ...
    public void testPutAndGet() {
        ...
        ConcurrentHashMap2<String, Integer> m = new ConcurrentHashMap2<>(4, String::length, 1);
        String s = "foobar";
        for (int i = 0; i < 10; i++) {
            m.put(s, i * s.length());
    ...
    public void testCollisions() {
        // we are passing a hash function that takes the prize for dumbness
        ConcurrentHashMap2<String, Integer> m = new ConcurrentHashMap2<>(10, String::length, 1);
        String s1 = "foobar";
        m.put(s1, s1.length());
