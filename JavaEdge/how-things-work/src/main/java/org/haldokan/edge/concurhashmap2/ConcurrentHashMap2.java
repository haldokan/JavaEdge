...
public class ConcurrentHashMap2<K, V> {
    ...
    public V put(K k, V v) {
        ...
        try {
            ...
            if (slot == SLOT_NOT_FOUND)
                throw new RuntimeException("Hash space is saturated - cannot hash value with open addressing: " + k
                        + "/" + v);
    ...
    public String toString() {
        return "ConcurrentHashMap2 [hashSpace=" + Arrays.toString(hashSpace) + ", hashRanges="
                + Arrays.toString(hashRanges) + "]";
    }
