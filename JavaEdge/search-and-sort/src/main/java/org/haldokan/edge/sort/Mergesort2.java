...
public class Mergesort2 {
	...
	private static <E extends Comparable<E>> void mergeArrays(List<E> l,
	...
	private static <E extends Comparable<E>> void mergeArrays(E[] d, int low,
			int mid, int high) {
	...
	// a merge buffer is needed when merging arrays
	private static <E extends Comparable<E>> void mergeArrays(E[] m, E[] c1,
			E[] c2) {
		int mi = 0;
		int j = 0;
		int k = 0;
